...
import com.sakksoftware.web.bbrestapioauth2.Service.TokenBlackListService;
...
public class AuthorizationConfig extends AuthorizationServerConfigurerAdapter {
    ...
    private Log logger = LogFactory.getLog(AuthorizationConfig.class);
    ...
    static class MyTokenService extends DefaultTokenServices {
        Log log = LogFactory.getLog(MyTokenService.class);
